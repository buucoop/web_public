        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              ...
              <a class="btn btn-primary float-right" href="<?php echo site_url('Officer/Training/add');?>"><i class="fa fa-plus"></i> เพิ่มการอบรม</a>
              ...
              <table class="table table-bordered" id="train_table">
                    ...
                    foreach ($data as $row){?>
                      <tr>
                        ...
                        <td class="text-left"><?php echo ($row['train']['train_start_date']); ?></td>
