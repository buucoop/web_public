                ...
                <form action="<?php echo site_url('Student/Job/print_data/');?>" method="post" id="form_checker">
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                     ...
                     <!--ส่วนของโทรศัพท์-->
                      <div class="form-group col-sm-4">
                        <label for="ccnumber">โทร</label><code>หากไม่มีให้กรอกเครื่องหมาย -</code>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group row">
                      ...
                      <?php
                      $message = "กรุณาอ่านรายละเอียดแล้วทำการกรอกข้อมูลให้ครบถ้วน ไม่เช่นนั้นจะไม่สามารถ พิมพ์เอกสารได้";
                      ...
                      <div class="form-group col-sm-9">
                        <label for="name">ที่อยู่ที่ติดต่อได้</label>
                      ...
                      <div class="form-group col-sm-8">
                        ...
                        <input type="text" class="form-control" id="" value="<?php echo $student_profile['Contact_Address_Number']." ต.".$student_profile['Contact_Address_Tumbon']." อ.".$student_profile['Contact_Address_Aumper']." จ.".$student_profile['Contact_Address_Province']." รหัสไปรษณีย์ ".$student_profile['Home_Address_Postcode']; ?>" disabled>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="alert alert-dark text-center" role="alert">
                              <strong>ประวัติการศึกษา (EDUCATIONAL HISTORY)</strong> <code>*</code>
                            </div>
                        </div>
                    </div>
                     <!--br-->
                    ...
                    <tbody>
                      ...
                      <td><input type="text" class="form-control" min="<?php echo (date('Y')+543)-15;?>" max="<?php echo (date('Y')+5430)-1;?>" name="education_end_year[]"></td>
                  ...
                  <div class="row">
                        <div class="col-sm-12">
                            <div class="alert alert-dark text-center" role="alert"><strong>ประวัติการอบรม และกิจกรรมนอกหลักสูตร</strong> <code>*</code>
                        </div>
                    </div>
                    </div>
                     <!--br-->
                  ...
                  <div class="row">
                        <div class="col-sm-12">
                            <div class="alert alert-dark text-center" role="alert"><strong>จุดหมายงานอาชีพ (CAREER VISION)</strong> <code>*</code>
                        </div>
                    </div>
                    </div>
                     <!--br-->
                    ...
                    <div class="form-group row">
                    <div class="col-sm-12">
                      <p>ระบุสายงานและลักษณะงานอาชีพที่นิสิตสนใจ (List your career goals, fields of interest and job preferences.) <?php echo form_error('job_student');?></p>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="alert alert-dark text-center" role="alert"><strong>ความสามารถทางภาษา (LANGUAGE PROFICIENCY)</strong> <code>*</code>
                        </div>
                    </div>
                    </div>
                     <!--br-->
