             ...
             <a style="width:2%"></a>
              ...
              <div class="col-md-12">
                    <div class="alert alert-primary">
                        <b>**กรุณาเลือกนิสิตที่จะสัมภาษณ์ (สำหรับนิสิตที่ไม่ถูกเลือก หมายถึงปฏิเสธการสัมภาษณ์)</b>
              ...
              <div style="height:40px;"></div>
                          ...
                          <div class="col-sm-4">
                            <label></label>
                            <button type="button" class="btn btn-success" id="change_student_status">เรียกสัมภาษณ์นิสิต</button>                             
                          </div>
                        </div> 
...
$(document).ready(function() {
    ...
    var table = $('#student_table').DataTable( {
        ...
        'order': [[2, 'asc']],
        "ajax": {
          "url": "<?php echo site_url('Company/Job_list_position/ajax_list2');?>",
          "dataSrc": ""
        },
        "columns": [
...
function send_email_to_officer_ajax(selected_student_id)
{
      ...
      jQuery.post(SITE_URL+"/Company/Job_list_position/ajax_send_email_to_officer/", data, function() {
...
function change_company_type_ajax(arr, company_status_type, non_slected_student_id, selected_student_id)
{
  ...
  swal({
    title: "กรุณายืนยันนิสิตที่จะถูกเรียกสัมภาษณ์",
