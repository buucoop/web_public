...
<div align="center">
              ...
              <a style="width:2%"></a>
                                      <?php echo anchor('Company/Job_list_position/?company_status_id=4', '<i class="fa fa-list-alt"></i> ผ่านการสัมภาษณ์....', 'class="btn  btn-primary"');?>
...
$(document).ready(function() {
    ...
    var table = $('#student_table').DataTable( {
        ...
        'order': [[2, 'asc']],
        "ajax": {
          "url": "<?php echo site_url('Company/Job_list_position/ajax_list4');?>",
          "dataSrc": ""
        },
        "columns": [
