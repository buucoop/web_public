             ...
             <a style="width:2%"></a>
              ...
              <div class="col-md-12">
                    <div class="alert alert-primary">
                        <b>**กรุณาเลือกนิสิตที่จะมีสิทธิ์เรียกสัมภาษณ์ (สำหรับนิสิตที่ไม่ถูกเลือก หมายถึงปฏิเสธการเรียกสัมภาษณ์)</b>
              ...
              <div style="height:40px;"></div>
                    <!--
                        <div class="container-fluid row">
                          ...
                          <div class="col-sm-4">
                            <label></label>
                            <button type="button" class="btn btn-success" id="change_student_status">เลือกนิสิตรอสัมภาษณ์</button>                             
                          </div>
                        </div> 
...
$(document).ready(function() {
    ...
    var table = $('#student_table').DataTable( {
        ...
        'order': [[2, 'asc']],
        "ajax": {
          "url": "<?php echo site_url('Company/Job_list_position/ajax_list1');?>",
          "dataSrc": ""
        },
        "columns": [
    ...
    $('#change_student_status').click( function () {
      ...
      change_company_type_ajax(arr, company_status_type_val, non_slected_student_id)
...
function change_company_type_ajax(arr, company_status_type, non_slected_student_id)
{
  ...
  swal({
    title: "กรุณายืนยันนิสิตที่จะเรียกสัมภาษณ์",
    text: "บริษัทจะไม่สามารถกลับมาเลือกนิสิตที่ไม่ได้ถูกเลือกได้อีก",
    icon: "warning",
    buttons: true,
    dangerMode: true,
  })
