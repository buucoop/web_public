...
class Main extends CI_Controller {
    ...
    public function index2()
	{
        ...
        $data['rowNews'] = $this->News->gets_news();
        $this->breadcrumbs->push('', '/Student/Job/lists');
        ...
        // print_r($data['documents']);
        $this->template->view('Student/Main_view2', $data);
    ...
    public function coop_register()
    {
	   ...
	   $data['sum_credit'] = @$this->Student->get_student_sum_credit($student_id);
        ...
        $this->session->set_flashdata('status', '<div class="alert alert-success">Downloads เอกสารเรียบร้อย กรุณานำเอกสารไปส่งที่ห้องเจ้าหน้าที่ ชั้น 2 ค่ะ</div>', 300);
        ...
        echo "
            ...
            <script>
                ...
                setTimeout(function(){
                    window.location = '".site_url('Student/main/index')."';
                }, 1500);
            </script>
        ";
    }
