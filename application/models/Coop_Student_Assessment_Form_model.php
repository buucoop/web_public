...
class Coop_Student_Assessment_Form_model extends CI_model {
    ...
    public function get_score_form_company_for_show_adviser()
    {
        $sql = 'select coop_student_has_coop_student_questionnaire_comment_totalscore from tb_coop_student_has_coop_student_questionnaire_comment where 59160855';
