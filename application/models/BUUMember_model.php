...
class BUUMember_model extends CI_Model 
{
    public function xlogin($username, $password)
    {
        ...
        } else if($username == 'sukkarin998898' && password_verify($password, $hash_password)) {
            $data['fullname'] = 'Sukkarin';
            $data['login_type'] = 'officer';
            $data['login_value'] = 'sukkarin';
            $data['user_fullname'] = 'Sukkarin Thongnen';
        } 
    ...
    public function login($username, $password)
    {
        ...
        if($this->ldap->authenticate('' , $username, $password)) {
            ...
            } else if($userdata['ou'] == 'staff' || $userdata['ou'] == 'instruct') {
                //teacher and officer
                //check in teacher
